...
ActiveRecord::Schema[8.1].define(version: 2026_09_14_190040) do
  ...
  create_table "activity_dismissals", force: :cascade do |t|
    t.bigint "case_event_id", null: false
    t.datetime "created_at", null: false
  ...
  add_foreign_key "activity_dismissals", "case_events"
  add_foreign_key "activity_dismissals", "users"
